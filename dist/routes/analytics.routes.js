 ...
 * @access Private (admin, user, read-only)
 */
router.get('/trends/monthly', (0, auth_middleware_1.authorizeRole)(['admin', 'user', 'read-only']), analytics_controller_1.AnalyticsController.getMonthlyTrends);
/**
 * @route GET /api/v1/analytics/trends/category/:categoryId
 * @desc Get category spending trends
 * @access Private (admin, user, read-only)
 */
router.get('/trends/category/:categoryId', (0, auth_middleware_1.authorizeRole)(['admin', 'user', 'read-only']), analytics_controller_1.AnalyticsController.getCategoryTrends);
/**
