...
describe('Security Middleware Tests', () => {
  ...
  describe('Authentication Security', () => {
    ...
    it('should clear cookies on logout', async () => {
      ...
      const clearCookies = logoutResponse.headers['set-cookie'] as unknown as string[];
      expect(clearCookies).toBeDefined();
      
      const clearedSession = clearCookies?.find((cookie: string) => cookie.includes('sessionToken=;'));
      const clearedRefresh = clearCookies?.find((cookie: string) => cookie.includes('refreshToken=;'));
